...
const style = {
    wrapper: `pt-2`,
    searchHeader: `font-mono w-full font-bold text-left flex items-center text-3xl p-4 overflow-hidden text-blue-300`,
    ...
    svgContainer: `mx-1`,
    input: `font-mono my-2 rounded-2 p-2 outline-none border-none bg-transparent  h-full w-full`,
    verticalLine: `w-0 h-[2rem] border-blue-300 border absolute z-10 left-[2.3rem] top-[2rem]`,
  }
  ...
  const LocationSelector = () => {
    ...
    const { pickup, setPickup, dropoff, setDropoff } = useContext(MobiContext)
    return (
